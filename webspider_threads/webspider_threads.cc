...
ThreadsafeQueue *WebSpiderThreads::tsqueue = new ThreadsafeQueue();

WebSpiderThreads::WebSpiderThreads(int max_threads)
    : max_threads(max_threads) {}

void WebSpiderThreads::crawl_web(std::string root_webpage_address) {
  // Do stuff
